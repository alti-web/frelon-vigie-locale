...
export const Route = createFileRoute("/correze-19/$commune")({
  loader: ({ params }) => {
    const c = getCommune(params.commune);
    if (!c || c.departement !== "19") throw notFound();
    return { commune: c };
  },
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        },
        {
          ...
          content: `Tableau de bord et signalements pour la commune de ${c.nom} (Corrèze).`,
        },
      ],
    };
  },
